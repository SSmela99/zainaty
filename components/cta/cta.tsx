...
export function Cta() {
  return (
    <section
      data-cursor-invert
      className="relative overflow-hidden bg-[#151414] py-20 text-white md:py-28 dark:bg-[#daff02] dark:text-zinc-950"
    >
      <Floater
      ...
      <Reveal className="relative z-10 mx-auto max-w-425 px-14 md:px-20 text-center">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          <Link
            ...
            className="cursor-pointer rounded-[5px] bg-[#f24a00] px-6 py-3.5 text-sm leading-none font-black text-white transition-transform hover:-translate-y-0.5 hover:scale-105 dark:bg-zinc-950 dark:text-white"
          >

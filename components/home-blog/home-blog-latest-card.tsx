    ...
    >
      ...
      <div className="flex min-w-0 flex-1 items-center gap-4 py-5 pr-5 pl-5 md:gap-5 md:py-5 md:pr-6 md:pl-6">
        <div className="min-w-0 flex-1">
          {primaryTag ? (
            <p className="text-[11px] font-bold tracking-[0.18em] text-[#1a4dff] uppercase dark:text-[#7d9bff]">
              {primaryTag}
            </p>
          ) : null}

          <h3 className="mt-1 line-clamp-2 text-base leading-snug font-black tracking-[-0.02em] text-zinc-950 transition-colors group-hover:text-[#ff4b12] dark:text-white dark:group-hover:text-[#d7ff00]">
            {post.title}
          </h3>
        ...
        <span
          aria-hidden
          className="inline-flex size-8 shrink-0 items-center justify-center rounded-full bg-[#ffe1cc] text-[#ff4b12] transition-colors group-hover:bg-[#ff4b12] group-hover:text-white md:size-9 dark:bg-[#3a3d10] dark:text-[#d7ff00] dark:group-hover:bg-[#d7ff00] dark:group-hover:text-zinc-950"
        >
